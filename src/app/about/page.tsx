    ...
    <div className="max-w-3xl mx-auto space-y-12">
      <div className="space-y-4">
        ...
        <p className="text-lg text-neutral-600 dark:text-neutral-400 leading-relaxed">
          Hi there! I'm Pascal Stehling, a Data Engineer and Data Architect based in Potsdam, near Berlin. I'm currently a Senior Data Architect at <Link href="https://catenion.com/" className="underline hover:text-black dark:hover:text-white">Catenion</Link>, where I also unofficially serve as the go-to IT person for everything from cloud infrastructure and data pipelines to internal web application development.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-neutral-500">Me in front of a castle in Potsdam.</p>
        </div>
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-neutral-500">This is how I picture myself when I'm coding.</p>
        </div>
      </div>
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <p>
          Let's see what the future holds! If you find anything I'm working on interesting, feel free to reach out at <Link href="mailto:web@stehl.ing">web@stehl.ing</Link>.
        </p>
      </div>
    </div>
  );
